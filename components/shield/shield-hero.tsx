    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="lg:w-[58%]">
          ...
          <h1
            ref={headlineRef}
            className="text-4xl sm:text-5xl lg:text-[3.25rem] xl:text-[3.75rem] font-bold tracking-tight text-white leading-[1.08] mb-6"
                  ...
                  >
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-[#C0C8D8]">{item.label}</span>
                      </div>
                      <span
