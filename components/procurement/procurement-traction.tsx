...
const validations = [
  ...
  },
  {
    ...
    title: "Pipeline",
    description:
      "Partner conversations underway for deployment within government ministries. Deployment structured to run alongside live tender cycles with zero operational disruption.",
  },
]
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div ref={bodyRef} className="max-w-3xl mb-14 opacity-0">
          ...
          <p className="text-base text-[#5A5A5A] leading-relaxed mb-4">
            ...
            ministries. These deployments will run alongside live tender cycles —
            zero disruption to existing workflows, committees, or ERP systems —
            and will produce the third-party verifiable deployment record that
            confirms what the platform already demonstrates internally.
          </p>
