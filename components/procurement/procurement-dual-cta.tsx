        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-sm text-white/65 leading-relaxed mb-7">
              Monakes deploys alongside your existing procurement workflows,
              generating a complete contemporaneous record without changing your
              committee, legal timelines, or ERP. The platform provides
              institutional evidence on your terms, inside your infrastructure,
          ...
          >
            ...
            <p className="text-sm text-white/65 leading-relaxed mb-7">
              ...
              requirement. The platform is operational and validated against
              international arbitration standards. Monakes delivers defensible
              AI decisions that meet sovereign compliance requirements.
            </p>
