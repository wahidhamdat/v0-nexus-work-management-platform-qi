...
export function Hero() {
  return (
    <section
      aria-label="Hero introduction to MonakesAI freight automation"
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, rgba(0,229,160,0.07) 0%, transparent 70%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, rgba(56,97,251,0.05) 0%, transparent 70%)",
        }}
      />

      <div className="relative z-10 max-w-[800px] mx-auto text-center">
        {/* Badge - CSS animation, not render-blocking */}
        <div className="hero-fade-up hero-delay-1 inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-[#111822] border border-[rgba(255,255,255,0.06)] mb-8">
          <span className="w-2 h-2 rounded-full bg-[#00e5a0] pulse-glow" />
          <span className="text-sm text-[#8892a4]">
            {"Trusted by Freight Teams Across 3 Continents"}
          </span>
        </div>

        {/* Headline - VISIBLE IMMEDIATELY, no animation, this is the LCP element */}
        <h1
          className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-[#e8ecf1] mb-6 leading-[1.05]"
          style={{ fontFamily: "var(--font-heading)" }}
        >
          <span className="block">{"Your Quote Lands First. Every Time."}</span>
          <span className="block text-[#00e5a0]">
            {"While Your Competitor Is Still Opening Their Spreadsheet."}
          </span>
        </h1>

        {/* Subheadline - CSS animation */}
        <p className="hero-fade-up hero-delay-2 text-base sm:text-lg text-[#8892a4] max-w-[640px] mx-auto mb-10 leading-relaxed">
        ...
        {/* CTAs - CSS animation */}
        <div className="hero-fade-up hero-delay-3 flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <Button
            size="lg"
        ...
        <div className="hero-fade-up hero-delay-4 flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-0">
