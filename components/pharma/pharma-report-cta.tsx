          ...
          {!submitted ? (
            ...
            >
              ...
              <input
                ...
                className="w-full sm:flex-1 px-5 py-3.5 rounded-full border border-[#D1D9E6] bg-white text-[#0A1628] text-sm placeholder:text-[#8892a4] focus:outline-none focus:ring-2 focus:ring-[#00B4D8] focus:border-transparent"
              />
              <button
                type="submit"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-[#00B4D8] text-white text-sm font-semibold hover:bg-[#0096B7] transition-colors shadow-[0_0_20px_rgba(0,180,216,0.15)]"
              >
                Send Me the Report
