    ...
    <SmoothScroll>
      ...
      <main id="main-content" className="min-h-screen bg-[#06090f]">
        ...
        <div className="sr-only" aria-hidden="true">
          ...
          <p>MonakesAI serves freight forwarders and 3PLs worldwide, from 5-person operations to enterprises with 200+ staff. Three additional agents are in development: Maya (Hub Transfer Orchestration, Q2 2026), Nova (Intelligent Communications, Q3 2026), and Finn (Financial Processing, Q4 2026).</p>
